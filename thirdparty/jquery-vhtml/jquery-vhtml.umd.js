(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2["jquery-vhtml"] = factory());
})(this, function() {
  "use strict";
  ...
  var isObject$2 = function isObject2(x) {
   ...
   */
  var browserSplit = function split2(undef) {
  ...
  var $exec$3 = bind.call($call, RegExp.prototype.exec);
  ...
  var encode$1 = function encode2(str, opts) {
  ...
  var htmlparserToVdom = function createConverter2(VNode2, VText2) {
    var converter = {
  ...
  var parseHTML$1 = function parseHTML2(html) {
  ...
  var createConverter = htmlparserToVdom;
  var parseHTML = parseHtml;
  var htmlToVdom$1 = function initializeHtmlToVdom(VTree, VText2) {
    var htmlparserToVdom2 = createConverter(VTree, VText2);
