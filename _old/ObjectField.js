...
(function($) {
     ...
     */
    {
        ...
        /**
         * @see Alpaca.ContainerField#_________renderItems
         */
        _________renderItems: function(onSuccess)
        {
            var _this = this;
        ...
        wizard: function()
        {
            ...
            steps.each(function(i) {
                ...
                if (wizardStepTemplateDescriptor) {
                    var wizardStepElement = Alpaca.tmpl(wizardStepTemplateDescriptor, {});
                ...
                if (wizardNavBarTemplateDescriptor) {
                    var wizardNavBarElement = Alpaca.tmpl(wizardNavBarTemplateDescriptor, {});
        ...
        _renderWizardStatusBar: function(stepTitles)
        {
            ...
            if (wizardStatusBar && stepTitles) {
                ...
                if (wizardStatusBarTemplateDescriptor) {
                    var wizardStatusBarElement = Alpaca.tmpl(wizardStatusBarTemplateDescriptor, {
        ...
        _createPrevButton: function(i, clear, validationFunction)
        {
            ...
            {
                var wizardPreButtonElement = Alpaca.tmpl(wizardPreButtonTemplateDescriptor, {});
        ...
        _createNextButton: function(i, clear, validationFunction)
        {
            ...
            if (wizardNextButtonTemplateDescriptor) {
                var wizardNextButtonElement = Alpaca.tmpl(wizardNextButtonTemplateDescriptor, {});
        ...
        _createDoneButton: function(i, clear, validationFunction)
        {
            ...
            if (wizardDoneButtonTemplateDescriptor) {
                var wizardDoneButtonElement = Alpaca.tmpl(wizardDoneButtonTemplateDescriptor, {});
