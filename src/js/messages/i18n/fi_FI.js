	...
	Alpaca.registerView ({
		...
		"messages": {
            "fi_FI": {
                ...
                "stringValueTooSmall": "Pienin sallittu merkkimäärä on {0}",
                "stringValueTooLarge": "Suurin sallittu merkkimäärä on {0}",
                "stringValueTooSmallExclusive": "Merkkimäärän pitää olla suurempi kuin {0}",
                "stringValueTooLargeExclusive": "Merkkimäärän pitää olla pienempi kuin {0}",
                "stringDivisibleBy": "Luku ei saa olla jaollinen luvulla {0}",
