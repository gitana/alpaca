    ...
    Alpaca.Fields.Select2EntityPicker = Alpaca.Fields.SelectFieldBase.extend({
        ...
        afterRenderControl: function (model, callback) {
            if (!this.isDisplayOnly()) {
                ...
                ServiceManagerLibrary.utils.entitypicker.setupEntitySelect2Control($select, -1, this.options.watermarkLabel, false, true, false, this.options.crossTenantSelection ? 'IncludeAllianceGuests' : 'Tenant');
            }
            callback();
        },
            ...
            var schemaOfOptions = Alpaca.merge(this.base(), {
                "properties": {                   
                    ...
                    "typeFilter": {
                        ...
                        "description": "The type of entity to pick.",
                        "type": "string",
                        "enum": ["CaseWorker", "UserAll", "UserPermanentEmployee", "ExternalGuestUser", "Causality", "EstablishImprovementMeasureAssessment", "CreditAuthorizationBreachCausality", "Product", "AppealsBody", "AuditScore", "ExtentProposedImprovementSuggestionIsTakenIntoAccount", "EducationalLevel", "EducationalDirection", "CompetenceLevel", "RecruitmentRequirementsAnalysisStatus", "EducationalEstablishment", "PersonalDataCategory", "PersonalDataProcessingArea", "CustomerChannel", "CustomerComplaintCategory", "InternalContractingParty"]
                    },
                    "actionType": {
                        "title": "Action type",
            ...
            var optionsForOptions = Alpaca.merge(this.base(), {
                "fields": {                    
                    ...
                    "typeFilter": {
                        ...
                        "type": "select",
                        "optionLabels": ["Brukere som kan benyttes i saksgang", "Alle brukere", "Fast ansatte (brukere)", "Eksterne gjestebrukere", "Årsakssammenheng", "Vurdering av behov for tiltak", "Årsak til brudd på kredittfullmakt", "Produkt", "Klageinstans", "Revisjonsresultat", "I hvilken grad foreslått forbedringsforslag tas til følge", "Utdanningsnivå", "Utdanningsretning", "Realkompetanse", "Status for behovsanalyse ved rekruttering", "Utdanningsinstitusjon", "Kategori av personopplysninger", "Personopplysningsbehandlingsområde", "Kundekanal", "Kundeklagekategori", "Intern kontraktspart"]
                    },
                    "actionType": {
                        "hideNone": false,
