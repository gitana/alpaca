                ...
                "properties": {                   
                    ...
                    "typeFilter": {
                        ...
                        "enum": [   
                            "CaseWorker",
                            "UserAll", 
                            "UserPermanentEmployee", 
                            "ExternalGuestUser",
                            "Causality", 
                            "EstablishImprovementMeasureAssessment", 
                            "CreditAuthorizationBreachCausality", 
                            "Product", 
                            "DivisionOnly",
                            "AppealsBody", 
                            "AuditScore", 
                            "ExtentProposedImprovementSuggestionIsTakenIntoAccount", 
                            "EducationalLevel", 
                            "EducationalDirection", 
                            "CompetenceLevel", 
                            "RecruitmentRequirementsAnalysisStatus", 
                            "EducationalEstablishment", 
                            "PersonalDataCategory", 
                            "PersonalDataProcessingArea", 
                            "CustomerChannel", 
                            "CustomerComplaintCategory", 
                            "InternalContractingParty", 
                            "SupplierCategory",
                        ]
                    },
                    "actionType": {
            ...
            var optionsForOptions = Alpaca.merge(this.base(), {
                "fields": {                    
                    ...
                    "typeFilter": {
                        ...
                        "type": "select",
                        "optionLabels": [
                            "Brukere som kan benyttes i saksgang",
                            "Alle brukere",
                            "Fast ansatte (brukere)",
                            "Eksterne gjestebrukere",
                            "Årsakssammenheng",
                            "Vurdering av behov for tiltak",
                            "Årsak til brudd på kredittfullmakt",
                            "Produkt",
                            "Kun divisjoner",
                            "Klageinstans",
                            "Revisjonsresultat",
                            "I hvilken grad foreslått forbedringsforslag tas til følge",
                            "Utdanningsnivå",
                            "Utdanningsretning",
                            "Realkompetanse",
                            "Status for behovsanalyse ved rekruttering",
                            "Utdanningsinstitusjon",
                            "Kategori av personopplysninger",
                            "Personopplysningsbehandlingsområde",
                            "Kundekanal",
                            "Kundeklagekategori",
                            "Intern kontraktspart",
                            "Leverandørkategori",
                        ]
                    },
                    "actionType": {
