...
$(function() {
    ...
    var componentExamples = [{
        ...
        "examples": [
            ...
            },
            {
                "id":"url-field",
                "title":"URL Field",
                "link":"../../components/fields/url-field.html"
            },
            {
                "id":"wysiwyg-field",
                "title":"WYSIWYG Field",
            ...
            },
            {
                "id":"zipcode-field",
                "title":"Zipcode Field",
                "link":"../../components/fields/zipcode-field.html"
            }
        ]
    }, {
        "title": "Form",
    ...
    if (!Alpaca.isValEmpty(currentExampleAlpacaTypes)) {
        ...
        if (alpacaTypeClass) {
            ...
            //schemaDocumentation.append('<h1 class="alpaca-schema-title">' + schemaOfSchema['title'] + '</h1>')
            schemaDocumentation.append('<p class="alpaca-schema-description">' + schemaOfSchema['description'] + '</p>');
